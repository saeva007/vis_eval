    ...
    rows = [
        {
            ...
            "label": "Full FE",
            "ablation_mode": "full",
            "checkpoint": "checkpoints/exp_1776227576_pm10_more_temp_search_feabl_full_S2_PhaseB_best_score.pt",
            "season_th_path": "checkpoints/exp_1776227576_pm10_more_temp_search_feabl_full_season_thresholds.pt",
            "fog_th": 0.10,
            "mist_th": 0.42,
